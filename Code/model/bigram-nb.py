...
for i in range(10):
    ...
    print "F1 Score: ",f1_score, "(",all_labels[i],")"

print "\nRunning bi-gram Multinomial NB"
...
print "\nRunning uni-gram Multinomial NB"
model_nb_tfidf = MultinomialNB(alpha=0.00001, fit_prior=True, class_prior=None)
